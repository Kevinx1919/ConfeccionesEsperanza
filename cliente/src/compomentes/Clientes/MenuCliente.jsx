...
import { ArrowLeft, BarChart3, ClipboardList, UserPlus } from 'lucide-react';
      ...
      <section className="overflow-hidden rounded-[28px] border border-slate-200 bg-white/95 shadow-[0_24px_80px_-32px_rgba(15,23,42,0.35)]">
        <div className="border-b border-slate-200 bg-[linear-gradient(135deg,#eff6ff_0%,#f8fafc_55%,#fdf2f8_100%)] px-5 py-8 sm:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600 sm:text-base">
              Registra, consulta y organiza la informacion de tus clientes.
            </p>
          </div>
        </div>
        ...
        <div className="px-5 py-6 sm:px-8 sm:py-8">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            >
              <div>
                ...
                <p className="mt-2 text-xl font-semibold sm:text-2xl">Consultar clientes</p>
              </div>
              <span className="rounded-2xl bg-white/15 p-3 ring-1 ring-white/20 transition group-hover:bg-white/20">
            ...
            >
              <div>
                ...
                <p className="mt-2 text-xl font-semibold sm:text-2xl">Generar reporte general</p>
              </div>
          ...
          <div className="mt-8 flex justify-center md:justify-end">
            <button
              id="boton_volver_menu_principal_cliente"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-slate-900 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-slate-900/20 transition hover:-translate-y-0.5 hover:bg-slate-800 focus:outline-none focus:ring-4 focus:ring-slate-300 boton_volver_menu_principal_cliente"
              onClick={() => navigate('/')}
            >
