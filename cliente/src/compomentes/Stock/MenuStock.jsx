      ...
      <section className="overflow-hidden rounded-[28px] border border-slate-200 bg-white/95 shadow-[0_24px_80px_-32px_rgba(15,23,42,0.35)]">
        ...
        >
          <div>
            ...
            <p className="mt-2 text-xl font-semibold sm:text-2xl">Registrar material</p>
          </div>
        ...
        >
          <div>
            ...
            <p className="mt-2 text-xl font-semibold sm:text-2xl">Consultar material</p>
          </div>
          <span className="rounded-2xl bg-white/15 p-3 ring-1 ring-white/20 transition group-hover:bg-white/20">
        ...
        >
          ...
          <div className="mt-8 flex justify-center md:justify-end">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-slate-900 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-slate-900/20 transition hover:-translate-y-0.5 hover:bg-slate-800 focus:outline-none focus:ring-4 focus:ring-slate-300 boton_volver_menu_principal_stock"
              onClick={() => navigate('/')}
            >
