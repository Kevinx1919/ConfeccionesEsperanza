...
namespace ConfeccionesEsperanzaEF.Services
{
    ...
    public class MaterialService : IMaterialService
    {
        ...
        // Constantes para mensajes de log (SOL-B-ERR-003)
        private const string LOG_MATERIAL_CREADO = "Material creado: {Nombre} con ID {IdMaterial}";
        private const string LOG_MATERIAL_ACTUALIZADO = "Material actualizado: {Nombre} con ID {Id}";
        private const string LOG_MATERIAL_ELIMINADO = "Material eliminado: {Nombre} con ID {Id}";
        private const string LOG_TIPO_MATERIAL_CREADO = "Tipo de material creado: {DescripcionMaterial} con ID {IdTipoMaterial}";
        ...
        public async Task<MaterialResponseDto> CreateMaterialAsync(CreateMaterialDto createMaterialDto)
        {
            try
            {
                ...
                // SOL-B-ERR-001/005: Optimización de logging con plantilla constante
                _logger.LogInformation(LOG_MATERIAL_CREADO, material.Nombre, material.IdMaterial);
        ...
        public async Task<MaterialResponseDto> UpdateMaterialAsync(int id, UpdateMaterialDto updateMaterialDto)
        {
            try
            {
                ...
                // SOL-B-ERR-002/004: Optimización de logging con plantilla constante
                _logger.LogInformation(LOG_MATERIAL_ACTUALIZADO, material.Nombre, id);
        ...
        public async Task<MaterialResponseDto> DeleteMaterialAsync(int id)
        {
            try
            {
                ...
                // SOL-B-ERR-005: Optimización de logging con plantilla constante
                _logger.LogInformation(LOG_MATERIAL_ELIMINADO, material.Nombre, id);
        ...
        public async Task<MaterialResponseDto> CreateTipoMaterialAsync(CreateTipoMaterialDto createTipoDto)
        {
            try
            {
                ...
                // SOL-B-ERR-006: Optimización de logging con plantilla constante
                _logger.LogInformation(LOG_TIPO_MATERIAL_CREADO, tipoMaterial.DescripcionMaterial, tipoMaterial.IdTipoMaterial);
